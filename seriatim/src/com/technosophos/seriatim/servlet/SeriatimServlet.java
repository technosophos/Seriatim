package com.technosophos.seriatim.servlet;
...
import com.technosophos.rhizome.web.BaseRhizomeServlet;
import com.technosophos.rhizome.web.BaseRhizomeSession;
import com.technosophos.rhizome.web.CommandClassPreloader;
import com.technosophos.rhizome.repository.RepositoryManager;
import com.technosophos.rhizome.web.ServletConstants;

/**
 * Servlet implementation class for Servlet: SeriatimServlet
 *
 * @web.servlet
 *   name="Seriatim"
 *   display-name="Seriatim" 
 *
 * @web.servlet-mapping
 *   url-pattern="/Time"
 *   
 ...
 *  
 */
 public class SeriatimServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	 ...
	 * <ul>
	 * <li>base_path: The path to this webapp's root directory. This is also stored with the key 
	 * "app_path" because of a problem with Velocity not recognizing base_path.</li>
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		params.put(ServletConstants.REQ_PARAM_SESSION, new SeriatimSession(request.getSession(true)));
	...
	public void init() throws ServletException {
		this.log("Initializing Rhizome-based servlet...");
		super.init();
		...
		try {
			cmdMap = CommandClassPreloader.preloadClasses(r.getCommandMap(), this.getClass().getClassLoader());
	...
	/**
	 * If the given String is not an absolute path, it is converted to one.
	 * 
	 * @return
	 */
