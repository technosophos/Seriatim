...
/**
 * This is a stopgap class until I can get Eclipse's classloader to use the correct
 * context for projects.
 * @see com.technosophos.rhizome.web.BaseRhizomeException
 * @author mbutcher
 *
 */
public class SeriatimSession implements RhizomeSession{
	/**
	 ...
	 * @param session
	 */
	public SeriatimSession(HttpSession session) {
		this.ses = session;
